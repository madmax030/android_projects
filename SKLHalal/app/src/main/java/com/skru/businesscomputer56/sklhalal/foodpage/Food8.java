...
public class Food8 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnShare.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra(Intent.EXTRA_TEXT, "ร้านแมะ  https://goo.gl/maps/pWoXNHQEXs12");
    ...
    public void onBtnClickMap(View view) {
        Uri gmmIntentUri = Uri.parse("google.navigation:q=7.172191, 100.611766 ");
    ...
    public void btnClickBack(View view) {
        Intent intent = new Intent(Food8.this, FoodActivity.class);
        startActivity(intent);
    }
}
