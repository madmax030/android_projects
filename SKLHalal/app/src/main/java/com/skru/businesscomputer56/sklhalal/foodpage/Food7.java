...
public class Food7 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.food_7);
        ...
        btnShare.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra(Intent.EXTRA_TEXT, "ร้านนั่งเล่น https://goo.gl/maps/ZNGUXyTPBY72");
    ...
    public void onBtnClickMap(View view) {
        Uri gmmIntentUri = Uri.parse("google.navigation:q=7.170827, 100.610187");
    ...
    public void btnClickBack(View view) {
        Intent intent = new Intent(Food7.this, FoodActivity.class);
        startActivity(intent);
    }
}
