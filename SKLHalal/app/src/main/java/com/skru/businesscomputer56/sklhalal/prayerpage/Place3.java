...
public class Place3 extends Activity {
    Button btnBack;
    Button  btn;
    RatingBar  ratingBar;
    Button btnMap;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.place_3);
        ...
        btnShare.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra(Intent.EXTRA_TEXT, "มัสยิดอัลอัซอัรอัลซารีฟ  https://goo.gl/maps/eGM3eJFWEQ82");
    ...
    public void onBtnClickMap(View view) {
        Uri gmmIntentUri = Uri.parse("google.navigation:q=7.184573, 100.596097");
    ...
    public void btnClickBack(View view) {
        Intent intent = new Intent(Place3.this, PlaceActivity.class);
        startActivity(intent);
    }
}
