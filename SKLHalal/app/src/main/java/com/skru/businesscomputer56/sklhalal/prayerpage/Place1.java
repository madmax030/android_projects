...
public class Place1 extends Activity {
    Button btnBack;
    Button  btn;
    RatingBar  ratingBar;
    Button btnMap;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.place_1);
        ...
        btnShare.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra(Intent.EXTRA_TEXT, "มัสยิดอัลฮีดาย๊ะห์(เก้าเส้ง)  https://goo.gl/maps/jzvgUV8sg9x");
    ...
    public void onBtnClickMap(View view) {
        Uri gmmIntentUri = Uri.parse("google.navigation:q=7.180379, 100.616548");
    ...
    public void btnClickBack(View view) {
        Intent intent = new Intent(Place1.this, PlaceActivity.class);
        startActivity(intent);
    }
}
