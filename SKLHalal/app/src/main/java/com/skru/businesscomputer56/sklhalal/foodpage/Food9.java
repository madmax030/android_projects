...
public class Food9 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.food_9);
        ...
        btnShare.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra(Intent.EXTRA_TEXT, "ร้านTOMYAM  https://goo.gl/maps/j4gHq7dYZSq");
    ...
    public void onBtnClickMap(View view) {
        Uri gmmIntentUri = Uri.parse("google.navigation:q=7.180778, 100.616677");
    ...
    public void btnClickBack(View view) {
        Intent intent = new Intent(Food9.this, FoodActivity.class);
        startActivity(intent);
    }
}
