...
public class Place4 extends Activity {
    Button btnBack;
    Button  btn;
    RatingBar  ratingBar;
    Button btnMap;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.place_4);
        ...
        btnShare.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra(Intent.EXTRA_TEXT, "มัสยิดบ้านปาบ  https://goo.gl/maps/1Jjkx18KH6z");
    ...
    public void onBtnClickMap(View view) {
        Uri gmmIntentUri = Uri.parse("google.navigation:q=7.137726, 100.626945");
    ...
    public void btnClickBack(View view) {
        Intent intent = new Intent(Place4.this, PlaceActivity.class);
        startActivity(intent);
    }
}
