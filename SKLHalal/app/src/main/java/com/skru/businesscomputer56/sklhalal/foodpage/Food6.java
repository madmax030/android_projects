...
public class Food6 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.food_6);
        ...
        btnShare.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra(Intent.EXTRA_TEXT, "ร้านบังอามีน https://goo.gl/maps/UKyeoPQULMx");
    ...
    public void onBtnClickMap(View view) {
        Uri gmmIntentUri = Uri.parse("google.navigation:q=7.172793, 100.612010");
    ...
    public void btnClickBack(View view) {
        Intent intent = new Intent(Food6.this, FoodActivity.class);
        startActivity(intent);
    }
}
