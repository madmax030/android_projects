...
public class Place6 extends Activity {
    Button btnBack;
    Button  btn;
    RatingBar  ratingBar;
    Button btnMap;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.place_6);
        ...
        btnShare.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra(Intent.EXTRA_TEXT, "มัสยิดควนหิน  https://goo.gl/maps/rLn1gbtAsN22");
    ...
    public void onBtnClickMap(View view) {
        Uri gmmIntentUri = Uri.parse("google.navigation:q=7.096308, 100.572334");
    ...
    public void btnClickBack(View view) {
        Intent intent = new Intent(Place6.this, PlaceActivity.class);
        startActivity(intent);
    }
}
