...
public class Place7 extends Activity {
    Button btnBack;
    Button  btn;
    RatingBar  ratingBar;
    Button btnMap;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.place_7);
        ...
        btnShare.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra(Intent.EXTRA_TEXT, "มัสยิดดารุนนาอีม  https://goo.gl/maps/gQ3PNXDdohq");
    ...
    public void onBtnClickMap(View view) {
        Uri gmmIntentUri = Uri.parse("google.navigation:q=6.561718, 100.899881");
    ...
    public void btnClickBack(View view) {
        Intent intent = new Intent(Place7.this, PlaceActivity.class);
        startActivity(intent);
    }
}
