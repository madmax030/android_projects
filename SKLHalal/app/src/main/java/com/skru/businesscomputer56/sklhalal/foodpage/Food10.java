...
public class Food10 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.food_10);
        ...
        btnShare.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra(Intent.EXTRA_TEXT, "ร้านก๋วยเตียวห้อยขา  https://goo.gl/maps/Ur8WCzDK6B72");
    ...
    public void onBtnClickMap(View view) {
        Uri gmmIntentUri = Uri.parse("google.navigation:q=7.169648, 100.610815");
    ...
    public void btnClickBack(View view) {
        Intent intent = new Intent(Food10.this, FoodActivity.class);
        startActivity(intent);
    }
}
